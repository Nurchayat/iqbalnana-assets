...
/**
 * ==================================================================================
 * Skrip Final Gabungan untuk Tema Blogger Iqbalnana (v7 - Stabil & Lengkap)
 * ==================================================================================
 ...
 * - Sistem Artikel Terkait Modern & Widget Gambar Mewarnai.
...
// 2. ===============================================================================
//    Skrip Utilitas SEO & Gambar (dari iqna.js)
// ==================================================================================
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    runWhenJQueryIsReady(function($) {
        ...
        var mobMenu=function(){$(".mobile-menu-toggle").on("click",function(a){a.preventDefault(),$("body").toggleClass("nav-active"),$(".overlay").fadeToggle("fast")}),$(".overlay").on("click",function(){$("body").removeClass("nav-active"),$(this).fadeOut("fast")}),$(".mobile-menu .m-sub").hide(),$(".mobile-menu .has-sub > a").on("click",function(a){a.preventDefault(),$(this).parent().toggleClass("show"),$(this).next(".m-sub").slideToggle("fast")})},searchNav=function(){$(".show-search").on("click",function(a){a.preventDefault(),$("body").toggleClass("search-active"),$("#nav-search").fadeToggle("fast")})},backTop=function(){$(window).on("scroll",function(){$(this).scrollTop()>100?$(".back-top").fadeIn("fast"):$(".back-top").fadeOut("fast")}),$(".back-top").on("click",function(){return $("html, body").animate({scrollTop:0},800),!1})};
        mobMenu();
        searchNav();
        backTop();
