/**
 * ==================================================================================
 * Skrip Fungsional Tambahan untuk Iqbalnana.com (v12 - Stabil)
 * ==================================================================================
 * Berkas ini berisi fungsionalitas unik yang tidak ada di themefunction.js.
 * Dirancang untuk bekerja bersama, bukan menggantikan skrip inti tema.
 *
 * Daftar Isi:
 * 1. Logika Homepage Kustom untuk label "Dongeng Anak".
 * 2. Sistem Artikel Terkait Modern (untuk Halaman Postingan).
 * 3. Widget Gambar Mewarnai.
 * 4. Utilitas SEO & Gambar.
 * 5. Inisialisasi Skrip.
 * ==================================================================================
 */
...
function initializeHomepageDongeng() {
    // Hanya jalankan jika elemen body memiliki class 'home'
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (document.body.classList.contains('item-post-wrap') || document.querySelector('.item-post-wrap')) {
